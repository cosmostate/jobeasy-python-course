...
string_1 = 'Python'
result_1 = string_1[0] # string_1[-6] or string_1[-len(string_1)]
result_2 = string_1[len(string_1) - 1] # string_1[5], string_1[-1], or string_1[len(string_1) - 1]
...
result_5 = string_4[10::2] # string_4[10:-1:2] or string_4[10:len(string_4) - 1:2]
